...
CREATE TABLE `eo_api` (
  ...
  `apiFailureMock` longtext COLLATE utf8_bin,
  `apiSuccessMock` longtext COLLATE utf8_bin,
  ...
  `apiNoteRaw` longtext COLLATE utf8_bin,
  `apiNote` longtext COLLATE utf8_bin,
  `apiRequestParamType` tinyint(4) unsigned NOT NULL DEFAULT '0',
  `apiRequestRaw` longtext COLLATE utf8_bin,
  `updateUserID` int(11) NOT NULL DEFAULT '0',
  `mockRule` longtext COLLATE utf8_bin,
  `mockResult` longtext COLLATE utf8_bin,
  `mockConfig` longtext COLLATE utf8_bin,
  `apiSuccessStatusCode` varchar(255) DEFAULT '200',
  `apiFailureStatusCode` varchar(255) DEFAULT '200',
  `beforeInject` longtext NULL,
  `afterInject` longtext NULL,
...
CREATE TABLE `eo_api_request_param` (
  ...
  `paramValue` longtext COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `eo_project_test_case_single` (
  ...
  `caseID` int(11) NOT NULL COMMENT '用例ID',
  `caseData` longtext COMMENT '内容',
  `caseCode` longtext COMMENT '用例代码',
